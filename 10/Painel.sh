...
mkdir /var/www/html
cd /var/www/html
wget http://sv.bigbolgames.com:8444/files/superuser/multipanel/panel_v10/painel10.zip > /dev/null 2>&1
sleep 1
...
sleep 1
cd
wget http://sv.bigbolgames.com:8444/files/superuser/multipanel/panel_v10/plus.sql > /dev/null 2>&1
sleep 1
...
echo -e "\033[1;37mwget http://sv.bigbolgames.com:8444/files/superuser/multipanel/panel_v10/revenda/confpainel/inst && bash inst\033[0m"
